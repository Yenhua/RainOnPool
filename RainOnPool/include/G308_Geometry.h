...
/**
 * Looks like I'll also use this for my raindrop variables too...
 */
class G308_Geometry
{
private:
...
public:
	...
	void Translate(float x, float y, float z); //Switch between showing filled polygons and wireframes
